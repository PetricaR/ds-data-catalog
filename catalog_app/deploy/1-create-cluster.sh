...
enable_apis() {
    ...
    local apis=(
        ...
        "aiplatform.googleapis.com"           # Vertex AI (for Gemini Insights)
        "bigquery.googleapis.com"             # BigQuery (catalog data source)
        "bigquerystorage.googleapis.com"      # BigQuery Storage API
        "secretmanager.googleapis.com"        # Secret Manager (BQ SA key)
...
print_summary() {
    ...
    echo "(Export this: export CLUSTER_NAME=$CLUSTER_NAME)"
}
